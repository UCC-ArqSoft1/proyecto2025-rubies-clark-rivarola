-- ----------------------------------------------------------------------------
-- Archivo: proyecto_completo.sql
-- Descripción: Crea la base de datos, las tablas y carga datos de ejemplo
--              para el sistema de actividades deportivas (Primera Entrega).
-- ----------------------------------------------------------------------------
...
-- 3) Tabla: horarios (cada fila es un turno concreto de una actividad)
--------------------------------------------
...
-- 5.1) Insertar usuarios de ejemplo
--------------------------------------------
...
-- 5.2) Insertar actividades de ejemplo
--------------------------------------------
...
-- 5.3) Insertar horarios relacionados a cada actividad
--------------------------------------------
...
-- 5.4) Insertar algunas inscripciones de ejemplo
--------------------------------------------
...
-- ------------------------------------------------------------------
-- Script: seed_extra.sql
-- Descripción: Inserta usuarios adicionales, actividades y horarios
...
VALUES
  ('Zumba Intermedio',
   ...
   25,
   'https://example.com/img/zumba_int.jpg',
   'Baile',
   'María López',
...
--------------------------------------------
-- Suponemos que las nuevas actividades obtuvieron IDs 4,5,6,7
-- Zumba Intermedio (actividad_id = 4)
INSERT INTO horarios (actividad_id, dia_semana, hora_inicio, duracion_min) VALUES
  (4, 'Mar', '18:00:00', 60),
  (4, 'Jue', '19:00:00', 60);
...
-- ------------------------------------------------------------------
-- Fin del script. Ahora tenés más usuarios, cuatro actividades nuevas
-- y varios horarios para probar tu frontend/back end.
-- ------------------------------------------------------------------
